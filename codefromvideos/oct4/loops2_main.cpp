...
void loops_infinite(void)
{
	...
	while (true) //infinite loop
	{
		cout << "count = " << count << endl;
		count++;
		if (count > num) //termination condition
